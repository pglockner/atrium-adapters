-- Sanitized Goose 1.50.0 session fixture. Synthetic data only.
...
-- assistant: two tool requests (1.48+ .value envelope) — shell (allowlisted) + load (not)
INSERT INTO messages (session_id, role, content_json, created_timestamp, timestamp, metadata_json)
...
-- user: matching tool responses (1.48+ .value envelope)
INSERT INTO messages (session_id, role, content_json, created_timestamp, timestamp, metadata_json)
VALUES ('20260908_fix', 'user',
